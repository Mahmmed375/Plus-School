                            ...
                            <form class="w-100 col-md-9" action="#" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="text-center col-lg-7  col-md-7">
                                        <label for="" class="label">اسم المدير</label>
                                        <input type="text" class="form-control w-100" name="admin"
                                            value="{{ @$admin }}" placeholder="اسم المدير " />
                                        <label for="" class="label">موقع المدرسة</label>
                                        <input type="text" class="form-control w-100" name="location"
                                            value="{{ @$location }}" placeholder="موقع المدرسة" />
                                        <label for="typ">شعار المؤسسة </label>
                                        <input type="text" class="form-control mb-3" value="{{ $logotext }}"
                                            name="logotext" placeholder=" " />
                                        <label for="typ">وصف المؤسسة</label>
                                        <textarea name="dis" class="form-control my-2 bg-transparent textarea" placeholder="اكتب وصف كامل عن المؤسسة ">{{ @$discription }}</textarea>
                                    ...
                                    <button value="1" name="updateinfo" onclick="alert('هل انت متاكد')" type="submit"
                                        class="btn  py-1 mt-3 justify-content-center text-center w-50">
                                        حفظ
                                    </button>
                    ...
                    <div class="tab-pane fade show   p-3  " id="class" role="tabpanel"
                        ...
                        <div class="contener">
                            <form class="w-100 col-md-9" action="#" method='POST' enctype='multipart/form-data'>
                                            ...
                                            @for ($i = 0; $i <= 8; $i++)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" class="form-control ro"
                                                            placeholder="المبلغ" name="pric{{ @$i }}"
                                                            value="{{ @$pric }}" />
                                                    </td>
                                                    <td><input type="number" class="form-control ro"
                                ...
                                <div class="button  justify-content-center text-center align-items-center">
                                    <button type="submit" name="updateClass" class="btn text-center  py-1 cdr ">
                                        حفظ
                                    </button>
                                </div>
                            </form>
