        ...
        <div class="container p-4">
            <div class="container text-right  ">
                ...
                <div class="justify-content-center my-5">
                    <form class="form-group text-end w-75" action='' method='POST'>
                        @csrf
            ...
            <div class="row">
                @if ($_SERVER['REQUEST_METHOD'] == 'POST')
                    @php
                        ...
                        $get_info2 = "SELECT * FROM `company` WHERE company_type='فني و حرفي' AND  cty='" . $caty . "'  AND company_ariea='" . $ariea . "';";
