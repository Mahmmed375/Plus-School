        ...
        <div class="container p-4">
            <div class="container text-left">
                ...
                <div class="justify-content-center my-5">
                    <form class="form-group text-end w-75" method="POST">
                        @csrf
                        ...
                        <div class="form-group my-3">
                            <label for="class">الفصل الدراسي:-</label>
                            <i class="bi bi-caret-down-fill"></i>
                        ...
                        <label for="pric">اختار المبلغ المناسب لك :-</label>
                        <input id="pric" type="number" class="form-control mb-3" name="pric"
                            value="{{ @$pric }}" minlength="10" maxlength="11" placeholder="المبلخ بالجنه" />
